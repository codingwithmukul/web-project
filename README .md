...
🚀 **Live Project Links:**
- **Development Preview (AI Studio):** [Click to view Development App](https://ais-dev-bp5qxafqooimhzah5b7tfd-182916276211.asia-southeast1.run.app)
- **Shared App (Public):** [Click to view Shared App](https://ais-pre-bp5qxafqooimhzah5b7tfd-182916276211.asia-southeast1.run.app) *(Note: This link will only work after you click "Share" in the top right corner of Google AI Studio)*
- **Production (Vercel):** *https://web-project-five.vercel.app* *(Placeholder for your future Vercel deployment)*
